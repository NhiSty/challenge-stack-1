 ...
 */
final class BackCrudMaker extends AbstractMaker
{
    ...
    {
        return 'Creates CRUD in the BACK for Doctrine entity class';
    }
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $templatesPath = '/Back/'.Str::asFilePath($controllerClassDetails->getRelativeNameWithoutSuffix());
