 ...
 */
final class FrontCrudMaker extends AbstractMaker
{
    ...
    {
        return 'Creates CRUD in the FRONT for Doctrine entity class';
    }
    ...
    public function generate(InputInterface $input, ConsoleStyle $io, Generator $generator): void
    {
        ...
        $templatesPath = '/Front/'.Str::asFilePath($controllerClassDetails->getRelativeNameWithoutSuffix());
